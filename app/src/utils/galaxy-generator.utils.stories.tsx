...
import { GalaxySize, assignPlanetsToPlayers, generateGalaxy } from "./galaxy-generator.utils";
...
export const GenerateLargeGalaxy: Story = {
  render: () => {
    ...
    return <StoryBookCanvasWrapper>
      <Galaxy planets={planets} />
    </StoryBookCanvasWrapper>
  },
};

const AssignPlayersEnvironment: FC<{ factions: number, galaxySize: GalaxySize }> = ({ factions, galaxySize }) => {
